...
success means only that the execution/measurement protocol passed. The framework has no operator-specific reference and reports correctness=not_checked. A standalone case proves neither numerical correctness, E2E reachability nor entire-model correctness; those require separate evidence.
